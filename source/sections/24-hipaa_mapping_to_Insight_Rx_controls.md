# 24. HIPAA Mappings to Insight Rx Controls

Below is a list of HIPAA Safeguards and Requirements and the Insight Rx controls in place to meet those.

| **Administrative Controls** HIPAA Rule | Insight Rx Control
--- | ---
...
| **Physical Safeguards** HIPAA Rule | Insight Rx Control
--- | ---
...
| **Technical Safeguards** HIPAA Rule | Insight Rx Control
---------------- | ----------------
